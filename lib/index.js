...
var matchers = require("./src/matchers");
var structjson = require("./src/structjson");
...
function request(text, source, languageCode, _a) {
    var sessionClient = _a[0], sessionPath = _a[1];
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    responses = _b.sent();
                    return [2 /*return*/, responses[0].queryResult];
            }
        });
    });
}
function createBot(projectId, source, languageCode) {
    if (languageCode === void 0) { languageCode = "en"; }
    var session = generateSession(projectId);
    return {
        request: function (text) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, request(text, source, languageCode, session)];
                        case 1:
                            response = _a.sent();
